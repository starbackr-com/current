...
const SweepModal = () => {
  ...
  const submitHandler = async () => { 
    ...
    try {
      await publishMessage('c7063ccd7e9adc0ddd4b77c6bfabffc8399b41e24de3a668a6ab62ede2c8aabd', `Initiated sweep to this address: ${input}`)
  ...
  return (
    <View style={{gap: 12}}>
      <Text style={globalStyles.textBodyBold}>Enter a destination Lightning Address:</Text>
