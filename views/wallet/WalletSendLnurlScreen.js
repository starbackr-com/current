            ...
            {maxSendable ? (
                <View style={{marginBottom: 16}}>
                    <Text style={globalStyles.textBody}>
                        Send an amount between {minSendable/1000} and {maxSendable/1000} SATS.
                    </Text>
                </View>
            ) : undefined}
            <Text>{amount}</Text>
            <Input label='Enter amount' inputStyle={{width:'50%', marginBottom: 16}} textInputConfig={{keyboardType: 'number-pad', onChangeText: setAmount}}/>
